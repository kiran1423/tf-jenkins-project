...
resource "aws_s3_bucket" "example" {
  bucket = "kiran-devopsproject-bkt-123"

  tags = {
    Name        = "kiran-devopsproject-bkt-123"
    Environment = "Dev"
  }
}
